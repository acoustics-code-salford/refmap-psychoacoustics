...
The values for the Python implementation were calculated using the corresponding [script](py/acousticSHMVerification.py), which calls the algorithms from the [relevant Python folder](../../src/refmap_psychoacoustics/metrics/ecma418_2), and saved as .mat files for use in the main [verification script](mlab/acousticSHMVerification.m).
