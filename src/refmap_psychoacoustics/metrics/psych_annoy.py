...
def widmannPA(loud5ExZwicker, sharp5ExWidmann, rough5ExFastl, fluct5ExFastl):
    ...
    sharp5ExWidmann : float or array
        Widmann-weighted sharpness values as defined in DIN 45692:2009 (using Zwicker loudness input),
...
# %% morePA
def morePA(loud5ExZwicker, sharp5ExWidmann, rough5ExFastl, fluct5ExFastl, tonal5ExAures):
    """
