function detectDiscount = acousticDetectFromLeqf(LeqTarget, LeqMasker, axisTarget, axisMasker, timeSkip, timeStep, freqMids, outPlot)
% detectDiscount = acousticDetectFromLeqf(LeqTarget, LeqMasker,
...
detectability = detectEfficiency.*LeqTarget./(repmat(LeqMasker, 1, 1, repMasker) + eqAuditoryNoise);
...
detectDiscount.timeOut = timeOut;
...
if outPlot
    ...
    for iiPlot = 1:targetChans
        ...
        hold off
        set(ax3, 'XLim', [(timeOut1); timeOut(end) + timeStep],...
