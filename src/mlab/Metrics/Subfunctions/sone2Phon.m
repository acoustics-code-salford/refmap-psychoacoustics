function phon = sone2Phon(sone, model)
% phon = sone2Phon(sone, model)
%
% Returns the loudness level(s) in phon corresponding with sensory loudness
% value(s) in sone, according to the specific loudness model(implemented
% models include:
% Zwicker as defined in ISO 532-1:2017,
% Moore-Glasberg as defined in ISO 532-2:2017,
% Moore-Glasberg-Schlittenlacher as defined in ISO 532-3:2023,
% Sottek Hearing Model as defined in ECMA-418-2:2025.
%
% Inputs
% ------
...
%
% model : keyword string (default: 'sottek'
%   The loudness model (options: 'sottek', 'zwicker', 'mg', 'mgs').
%
% Returns
% -------
% 
...
% Hearing Model. The output phon is returned either using a
% specified closed-form equation, or based on linear
...
switch model
    ...
    case 'zwicker'
        ...
        phon(sone >= 1) = 40 + 10/log10(2).*log10(sone(sone >= 1));
        phon(sone < 1) = 40*(sone(sone < 1)).^0.35;
    
    case 'mg'
        % values from ISO 532-2:2017 C code file P_subs2a_2011.c
        phonRange = [0; 0.5; 1; 1.5; 2; 2.2; 3; 3.5; 4; 4.5; 5; 5.5; 6; 6.5; 7.5;...
                     8.5; 10; 12.5; 15; 17.5; 20; 22.5; 25; 27.5; 30; 32.5; 35;...
                     37.5; 40; 42.5; 45; 47.5; 50; 52.5; 55; 57.5; 60; 62.5; 65;...
                     67.5; 70; 72.5; 75; 77.5; 80; 82.5; 85; 87.5; 90; 92.5; 95;...
    ...
    case 'mgs'
        % values from ISO 532-3:2023 MATLAB code file Phon2SoneTV2018.m
        phonRange = [0; 0.5; 1; 1.5; 2; 2.2; 3; 3.5; 4; 4.5; 5; 5.5; 6; 6.5; 7.5;...
                     8.5; 10; 12.5; 15; 17.5; 20; 22.5; 25; 27.5; 30; 32.5; 35;...
                     37.5; 40; 42.5; 45; 47.5; 50; 52.5; 55; 57.5; 60; 62.5; 65;...
                     67.5; 70; 72.5; 75; 77.5; 80; 82.5; 85; 87.5; 90; 92.5; 95;...
