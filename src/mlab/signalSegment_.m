function signalSegmented = signalSegment_(signal, axisn, blockSize, overlap, i_start)
% signalSegmented = acousticHMSSegment_(signal, axisn, blockSize, overlap)
%
