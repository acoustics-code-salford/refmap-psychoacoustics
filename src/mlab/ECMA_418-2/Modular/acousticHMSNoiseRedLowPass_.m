function signalFiltered = acousticHMSNoiseRedLowPass_(signal, sampleRatein)
% signalFiltered = acousticHMSNoiseRedLowPass_(signal, sampleRatein)
%
...
d = exp(-1/(sampleRatein*tau)); % Section 5.1.4.2 ECMA-418-2:2022
