appfunction [resampledSignal, resampledRate]...
          = acousticHMSResample_(signal, sampleRatein)
% [resampledSignal, resampledRate]...
%         = acousticHMSResample_(signal, sampleRatein)
%
% Returns signal resampled to 48 kHz, according to ECMA-418-2:2022
% (the Hearing Model of Sottek) for an input signal.
%
% Inputs
% ------
