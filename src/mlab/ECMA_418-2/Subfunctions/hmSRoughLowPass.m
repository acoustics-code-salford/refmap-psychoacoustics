function specRoughness = hmSRoughLowPass(specRoughEstTform, sampleRate, ...
                                         riseTime, fallTime)
% specRoughness = hmSRoughLowPass(specRoughEstTform, sampleRatein, riseTime, fallTime)
%
% Returns specific roughness low pass filtered for smoothing according to
% ECMA-418-2:2022 (the Hearing Model of Sottek) for an input transformed
