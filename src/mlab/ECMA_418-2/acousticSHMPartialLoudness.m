...
if chansOut == 3
    ...
    partLoudnessSHM.specTonalPartLoudnessBin = specTonalLoudness(:, :, 3);
    partLoudnessSHM.specNoisePartLoudnessBin = specNoiseLoudness(:, :, 3);
    ...
    partLoudnessSHM.specTonalPartLoudness = specTonalLoudness;
    partLoudnessSHM.specNoisePartLoudness = specNoiseLoudness;
