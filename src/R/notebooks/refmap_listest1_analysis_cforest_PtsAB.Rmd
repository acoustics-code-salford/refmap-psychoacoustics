...
stimDataNum <- cbind(stimData[, 'Stimulus'],
                      ...
                      stimData[, "IntermitRatioMaxLR", drop=F],
...
stimDataNum <- subset(stimDataNum, select = -c(UASLAeqMaxLR, UASLAEMaxLR))

colnames(stimDataNum)[1] <- "Stimulus"

# make the categorical outcome variables numerical dummy factors
# stimDataNum[['SNRlevel']] <- encode_ordinal(stimData[['SNRlevel']], order=SNRCats)
# stimDataNum[['UASLAeq']] <- encode_ordinal(stimData[['UASLAeq']], order=UASLAeqCats)
...
iVars <- names(stimDataNum)[which(names(stimDataNum) == 'UASEventPerMin'):which(names(stimDataNum) == 'UASImpulsSHM05ExMaxLR')]
iVars <- c(iVars,
...
p <- mtryTune(dataIn=stimDataNum, iVars=iVars, dVar=dVar, seed=seeds[1],
...
if (saveplots){
  ggsave(filename="PtsABdAnnoyMnAllVarsConPermimpPtv.svg", width=8, height=8, path=file.path(outFigPath, "svg"))
  unlink("PtsABdAnnoyMnAllVarsConPermimp.svg")
  
  ggsave(filename="PtsABdAnnoyMnAllVarsConPermimpPtv.pdf", width=8, height=8, path=file.path(outFigPath, "pdf"))
  unlink("PtsABdAnnoyMnAllVarsConPermimp.pdf")
}
...
if (saveplots){
  ggsave(filename="PtsABdAnnoyMnAbsVarsConPermimpPtv.svg", width=8, height=7, path=file.path(outFigPath, "svg"))
  unlink("PtsABdAnnoyMnAbsVarsConPermimpPtv.svg")
  
  ggsave(filename="PtsABdAnnoyMnAbsVarsConPermimpPtv.pdf", width=8, height=7, path=file.path(outFigPath, "pdf"))
...
if (saveplots){
  ggsave(filename="PtsABdAnnoyMnAbsVarsSkipAmbConPermimp.svg", width=8, height=11.5, path=file.path(outFigPath, "svg"))
  unlink("PtsABdAnnoyMnAbsVarsSkipAmbConPermimp.svg")
  
  ggsave(filename="PtsABdAnnoyMnAbsVarsSkipAmbConPermimp.pdf", width=8, height=11.5, path=file.path(outFigPath, "pdf"))
  unlink("PtsABdAnnoyMnAbsVarsSkipAmbConPermimp.pdf")
}
...
if (saveplots){
  ggsave(filename="PtsABdAnnoyMnAbsVarsSkipAmbConPermimpPtv.svg", width=8, height=7, path=file.path(outFigPath, "svg"))
  unlink("PtsABdAnnoyMnAbsVarsSkipAmbConPermimpPtv.svg")
  
  ggsave(filename="PtsABdAnnoyMnAbsVarsSkipAmbConPermimpPtv.pdf", width=8, height=7, path=file.path(outFigPath, "pdf"))
  unlink("PtsABdAnnoyMnAbsVarsSkipAmbConPermimpPtv.pdf")
}
...
resultsOutAbs.conimp1pc <- resultsOutAbs.conimp |>
                                          rownames_to_column('Metric') |>
                                                filter_if(is.numeric, all_vars(. > max(slice(resultsOutAbs.conimp, 1:n()-1))/100)) |>
                                                      column_to_rownames('Metric')
...
if (saveplots){
  ggsave(filename="PtsABdAnnoyMnAbsVarsSkipAmbConPermimp1pc.svg", width=8, height=3, path=file.path(outFigPath, "svg"))
  unlink("PtsABdAnnoyMnAbsVarsSkipAmbConPermimp1pc.svg")
  
  ggsave(filename="PtsABdAnnoyMnAbsVarsSkipAmbConPermimp1pc.pdf", width=8, height=3, path=file.path(outFigPath, "pdf"))
  unlink("PtsABdAnnoyMnAbsVarsSkipAmbConPermimp1pc.pdf")
}
...
iVars <- c(absVar, "UASEventPerMin", "AmbientLAeq", "UASSharpAurISO3PowAvgMaxLR", "UASSharpAurISO305ExMaxLR", "UASSharpAurSHMPowAvgMaxLR", "UASSharpAurSHM05ExMaxLR", "UASSharpAurISO1PowAvgMaxLR", "UASSharpAurISO105ExMaxLR", "UASSharpvBISO1PowAvgMaxLR", "UASSharpvBISO105ExMaxLR", "UASSharpDINPowAvgMaxLR", "UASSharpDIN05ExMaxLR")
dVar <- "dAnnoyMean"
...
iVars <- c(absVar, "UASEventPerMin", "AmbientLAeq", "UASTonalECMAAvgMaxLR", "UASTonalSHMInt05ExMaxLR", "UASTonalSHMIntAvgMaxLR", "UASTonalECMA05ExMaxLR", "UASTonLdECMAPowAvgBin", "UASTonLdECMA05ExBin", "UASTonalAurAvgMaxLR", "UASTonalAur05ExMaxLR", "UASTonalAur10ExMaxLR")
dVar <- "dAnnoyMean"
...
iVars <- c(absVar, "UASEventPerMin", "AmbientLAeq", "UASTonalECMAAvgMaxLR", "UASTonalSHMInt05ExMaxLR", "UASTonalSHMIntAvgMaxLR", "UASTonalECMA05ExMaxLR", "UASTonalAurAvgMaxLR", "UASTonalAur05ExMaxLR", "UASTonalAur10ExMaxLR")
dVar <- "dAnnoyMean"
...
# Fluctuation strength
iVars <- c(absVar, "UASEventPerMin", "AmbientLAeq", "UASFluctSHM10ExBin", "UASFluctSHM05ExBin", "UASFluctFZ10ExMaxLR", "UASFluctFZ05ExMaxLR", "UASFluctOV10ExMaxLR", "UASFluctOV05ExMaxLR")
dVar <- "dAnnoyMean"
...
# Roughness
iVars <- c(absVar, "UASEventPerMin", "AmbientLAeq", "UASRoughECMA10ExBin", "UASRoughECMA05ExBin", "UASRoughFZ10ExMaxLR", "UASRoughFZ05ExMaxLR", "UASRoughDW10ExMaxLR", "UASRoughDW05ExMaxLR")
dVar <- "dAnnoyMean"
...
```{r}
# Impulsiveness
iVars <- c(absVar, "UASEventPerMin", "AmbientLAeq", "UASImpulsSHMAvgMaxLR", "UASImpulsSHM05ExMaxLR", "UASImpulsSHMPowAvgMaxLR")
dVar <- "dAnnoyMean"
...
iVars <- c(absVar, "UASEventPerMin", "AmbientLAeq", sharpVar, tonLdVar, fluctVar, roughVar, impulsVar)
dVar <- "dAnnoyMean"
...
iVars <- c(absVar, "UASEventPerMin", "AmbientLAeq", sharpVar, tonalVar, fluctVar, roughVar, impulsVar)
dVar <- "dAnnoyMean"
...
resdAnnoyMnFitAB['Abs SQMs no tonal loud', 'RMSE'] <- resultsOutSQMs2$OOB_MAE
...
if (saveplots){
  ggsave(filename="PtsABdAnnoyMnDiffVarsConPermimp1pc.svg", width=8, height=3, path=file.path(outFigPath, "svg"))
  unlink("PtsABdAnnoyMnDiffVarsConPermimp1pc.svg")
  
  ggsave(filename="PtsABdAnnoyMnDiffVarsConPermimp1pc.pdf", width=8, height=3, path=file.path(outFigPath, "pdf"))
...
iVars <- c(diffVar, "UASEventPerMin", "dSharpAurISO3PowAvgMaxLR", "dSharpAurISO305ExMaxLR", "dSharpAurSHMPowAvgMaxLR", "dSharpAurSHM05ExMaxLR")
dVar <- "dAnnoyMean"
...
iVars <- c(diffVar, "UASEventPerMin", "dTonalECMAAvgMaxLR", "dTonalSHMInt05ExMaxLR", "dTonalSHMIntAvgMaxLR", "dTonalECMA05ExMaxLR", "dTonLdECMAPowAvgBin", "dTonLdECMA05ExBin")
dVar <- "dAnnoyMean"
...
iVars <- c(diffVar, "UASEventPerMin", "dTonalECMAAvgMaxLR", "dTonalSHMInt05ExMaxLR", "dTonalSHMIntAvgMaxLR", "dTonalECMA05ExMaxLR")
dVar <- "dAnnoyMean"
...
# Fluctuation strength
iVars <- c(diffVar, "UASEventPerMin", "dFluctSHM10ExBin", "dFluctSHM05ExBin", "dFluctOV10ExMaxLR", "dFluctOV05ExMaxLR")
dVar <- "dAnnoyMean"
...
iVars <- c(diffVar, "UASEventPerMin", dSharpVar, dTonLdVar, dFluctVar, dRoughVar, dImpulsVar)
dVar <- "dAnnoyMean"
...
iVars <- c(diffVar, "UASEventPerMin", dSharpVar, dTonalVar, dFluctVar, dRoughVar, dImpulsVar)
dVar <- "dAnnoyMean"
...
resdAnnoyMnFitAB['Diff SQMs no tonal loud', 'RMSE'] <- resultsOutSQMs2$OOB_MAE
...
if (saveplots){
  ggsave(filename="PtsABdHiAnnoyAllVarsConPermimpPtv.svg", width=8, height=14, path=file.path(outFigPath, "svg"))
  unlink("PtsABdHiAnnoyAllVarsConPermimp.svg")
  
  ggsave(filename="PtsABdHiAnnoyAllVarsConPermimpPtv.pdf", width=8, height=14, path=file.path(outFigPath, "pdf"))
  unlink("PtsABdHiAnnoyAllVarsConPermimp.pdf")
}
...
if (saveplots){
  ggsave(filename="PtsABdHiAnnoyAllVarsConPermimp1pc.svg", width=8, height=4, path=file.path(outFigPath, "svg"))
  unlink("PtsABdHiAnnoyAllVarsConPermimp1pc.svg")
  
  ggsave(filename="PtsABdHiAnnoyAllVarsConPermimp1pc.pdf", width=8, height=4, path=file.path(outFigPath, "pdf"))
...
resdHiAnnoyFitAB['Abs SQMs no tonal loud', 'RMSE'] <- resultsOutSQMs2$OOB_MAE
...
resdHiAnnoyFitAB['Diff SQMs no tonal loud', 'RMSE'] <- resultsOutSQMs2$OOB_MAE
...
# rename the columns
colnames(resAbsPermImpTblAB)[2:3] <- c("Mean change in annoyance", "%HA [p(HA | 0)]")
...
resAbsAB$Outcome <- factor(resAbsAB$Outcome, levels=c("Mean change in annoyance", "%HA [p(HA | 0)]"))
...
# rename the columns
colnames(resDiffPermImpTblAB)[2:3] <- c("Mean change in annoyance", "%HA [p(HA | 0)]")
...
# Reorder outcome levels
resDiffAB$Outcome <- factor(resDiffAB$Outcome, levels=c("Mean change in annoyance", "%HA [p(HA | 0)]"))

# plot res as horizontal bar chart, with Imp as y axis, Variable as x axis, Outcome as fill, and Variable_sum as order, relabel x axis with Variable names
pBar <- ggplot(resDiffAB) + geom_col(aes(fill=Outcome, y=Imp, x=Order), colour='grey35',  width=0.75, show.legend=TRUE) + labs(x="Variable", y="Normalised variable permutation importance") + theme(text = element_text(family = "serif"), panel.grid=element_line(color = rgb(235, 235, 235, 100, maxColorValue = 255), linewidth = 0.25, linetype = 2), legend.position = "right") + coord_flip(ylim=c(-0.1, 2)) + scale_fill_manual(values=mycolours) + scale_x_discrete(labels=unique(rev(resDiffAB$Variable)))
pBar

if (saveplots){
  ggsave(filename="PtsABcrfDiffSQMsSummary.svg", width=8, height=4, path=file.path(outFigPath, "svg"))
  unlink("PtsABcrfDiffSQMsSummary.svg")
  
  ggsave(filename="PtsABcrfDiffSQMsSummary.pdf", width=8, height=4, path=file.path(outFigPath, "pdf"))
...
# rename the columns
colnames(resAbsPermImpNoTonLdTblAB)[2:3] <- c("Mean change in annoyance", "%HA [p(HA | 0)]")
...
# Reorder outcome levels
resAbsNoTonLdAB$Outcome <- factor(resAbsNoTonLdAB$Outcome, levels=c("Mean change in annoyance", "%HA [p(HA | 0)]"))

# plot res as horizontal bar chart, with Imp as y axis, Variable as x axis, Outcome as fill, and Variable_sum as order, relabel x axis with Variable names
pBar <- ggplot(resAbsNoTonLdAB) + geom_col(aes(fill=Outcome, y=Imp, x=Order), colour='grey35',  width=0.75, show.legend=TRUE) + labs(x="Variable", y="Normalised variable permutation importance") + theme(text = element_text(family = "serif"), panel.grid=element_line(color = rgb(235, 235, 235, 100, maxColorValue = 255), linewidth = 0.25, linetype = 2), legend.position = "right") + coord_flip(ylim=c(-0.1, 2)) + scale_fill_manual(values=mycolours) + scale_x_discrete(labels=unique(rev(resAbsNoTonLdAB$Variable)))
pBar

if (saveplots){
  ggsave(filename="PtsABcrfAbsSQMsNoTonLdSummary.svg", width=8, height=4, path=file.path(outFigPath, "svg"))
  unlink("PtsABcrfAbsSQMsNoTonLdSummary.svg")
  
  ggsave(filename="PtsABcrfAbsSQMsNoTonLdSummary.pdf", width=8, height=4, path=file.path(outFigPath, "pdf"))
...
# rename the columns
colnames(resDiffPermImpNoTonLdTblAB)[2:3] <- c("Mean change in annoyance", "%HA [p(HA | 0)]")
...
# Reorder outcome levels
resDiffNoTonLdAB$Outcome <- factor(resDiffNoTonLdAB$Outcome, levels=c("Mean change in annoyance", "%HA [p(HA | 0)]"))

# plot res as horizontal bar chart, with Imp as y axis, Variable as x axis, Outcome as fill, and Variable_sum as order, relabel x axis with Variable names
pBar <- ggplot(resDiffNoTonLdAB) + geom_col(aes(fill=Outcome, y=Imp, x=Order), colour='grey35',  width=0.75, show.legend=TRUE) + labs(x="Variable", y="Normalised variable permutation importance") + theme(text = element_text(family = "serif"), panel.grid=element_line(color = rgb(235, 235, 235, 100, maxColorValue = 255), linewidth = 0.25, linetype = 2), legend.position = "right") + coord_flip(ylim=c(-0.1, 2)) + scale_fill_manual(values=mycolours) + scale_x_discrete(labels=unique(rev(resDiffNoTonLdAB$Variable)))
pBar

if (saveplots){
  ggsave(filename="PtsABcrfDiffSQMsNoTonLdSummary.svg", width=8, height=4, path=file.path(outFigPath, "svg"))
  unlink("PtsABcrfDiffSQMsNoTonLdSummary.svg")
  
  ggsave(filename="PtsABcrfDiffSQMsNoTonLdSummary.pdf", width=8, height=4, path=file.path(outFigPath, "pdf"))
