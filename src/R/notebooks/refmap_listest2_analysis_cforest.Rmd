...
if (savedata){
  ...
  openxlsx::write.xlsx(temp, paste(outDataPath, "\\CRFdAnnoyMnConPermimp.xlsx",
                                   sep=""),
                       rowNames=TRUE)
}
...
if (savedata){
  ...
  openxlsx::write.xlsx(temp, paste(outDataPath, "\\CRFdHiAnnoyConPermimp.xlsx",
                                   sep=""),
                       rowNames=TRUE)
}
...
if (savedata){
  ...
  openxlsx::write.xlsx(temp, paste(outDataPath, "\\CRFSummary.xlsx",
                                   sep=""),
                       rowNames=TRUE)
}
