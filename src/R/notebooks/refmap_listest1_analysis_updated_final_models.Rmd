...
p1 <- p1 + theme(panel.grid.major = element_line(colour = "grey90", alpha=0.05, linetype='dashed'),
                 panel.grid.minor = element_blank())
p2 <- p2 + theme(panel.grid.major = element_line(colour = "grey90", alpha=0.05, linetype='dashed'),
                 panel.grid.minor = element_blank())
p3 <- p3 + theme(panel.grid.major = element_line(colour = "grey90", alpha=0.05, linetype='dashed'),
                 panel.grid.minor = element_blank())
p4 <- p4 + theme(panel.grid.major = element_line(colour = "grey90", alpha=0.05, linetype='dashed'),
                 panel.grid.minor = element_blank())
