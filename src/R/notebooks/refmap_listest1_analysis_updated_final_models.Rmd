...
p1 <- p1 + theme(panel.grIDmajor = element_line(colour = "grey90", alpha=0.05, linetype='dashed'),
                 panel.grIDminor = element_blank())
p2 <- p2 + theme(panel.grIDmajor = element_line(colour = "grey90", alpha=0.05, linetype='dashed'),
                 panel.grIDminor = element_blank())
p3 <- p3 + theme(panel.grIDmajor = element_line(colour = "grey90", alpha=0.05, linetype='dashed'),
                 panel.grIDminor = element_blank())
p4 <- p4 + theme(panel.grIDmajor = element_line(colour = "grey90", alpha=0.05, linetype='dashed'),
                 panel.grIDminor = element_blank())
...
model1 <- mABISxTnLAEx1_QSq.GEE <- glmtoolbox::glmgee(dAnnoyance ~ UASLAEMaxLRScl*I(UASEvents^-1) +
                                                     ...
                                                     UASSharpAurISO305ExBin*UASTonLdECMAPowAvgBin +
                                                     TrialNumberScl,
                                                    data=subjDataNoAmb,
                                                    family=gaussian(link='identity'),
                                                    id=ID,
...
model1predictLxS <- ggeffects::predict_response(model1, terms=c("UASLAEMaxLRScl [-12:13]",
                                                               "UASSharpAurISO305ExBin [1.2:2.8, by=0.4]",
                                                                 "UASEvents [1]"),
                                             margin='marginalmeans', type='fixed', 
                                            vcov=vcov(model1, type="bias-corrected"))
...
model1predictSxTn <- ggeffects::predict_response(model1, terms=c("UASSharpAurISO305ExBin [all]",
                                                                 "UASTonLdECMAPowAvgBin [0.5:1.5, by=0.25]",
                                                                 "UASEvents [1]",
                                                                 "UASLAEMaxLRScl [8]"),
                                             margin='marginalmeans', type='fixed', 
...
p2 <- ggplot(data=model1predictLxS) +
              ...
              geom_point(data=stimDataNoAmb, aes(x=UASLAEMaxLRScl, y=dAnnoyMean, colour=UASSharpAurISO305ExBin, shape=factor(UASEvents)),
                         alpha=0.55, size=2) +
...
p4 <- ggplot(data=model1predictSxTn) +
              ...
              geom_point(data=stimDataNoAmb, aes(x=UASSharpAurISO305ExBin, y=dAnnoyMean, colour=UASTonLdECMAPowAvgBin, shape=factor(UASEvents)),
                         alpha=0.55, size=2) +
...
model1predictEnvS <- ggeffects::predict_response(model1, terms=c("UASSharpAurISO305ExBin [all]",
                                                                 "AmbientEnv [all]",
                                                                 "UASEvents [1]"),
                                             margin='marginalmeans', type='fixed', 
                                            vcov=vcov(model1, type="bias-corrected"))

model1predictEnvSxTn <- ggeffects::predict_response(model1, terms=c("UASSharpAurISO305ExBin [all]",
                                                                   "UASTonLdECMAPowAvgBin [0.5:1.5, by=0.25]",
...
model1predictPkASxTn <- ggeffects::predict_response(model1, terms=c("UASSharpAurISO305ExBin [all]",
                                                                   "UASTonLdECMAPowAvgBin [0.5:1.5, by=0.25]",
...
model1predictIxS <- ggeffects::predict_response(model1, terms=c("UASImpulsSHMAvgMaxLR [all]",
                                                                "UASSharpAurISO305ExBin [1.3:2.8, by=0.5]",
                                                                "AmbientEnv [all]",
                                                                 "UASEvents [1]"),
                                             margin='marginalmeans', type='fixed', 
                                            vcov=vcov(model1, type="bias-corrected"))
...
p3 <- ggplot(data=model1predictEnvS) +
              ...
              geom_point(data=stimDataNoAmb, aes(x=UASSharpAurISO305ExBin, y=dAnnoyMean, colour=AmbientEnv, shape=factor(UASEvents)),
                         alpha=0.55, size=2) +
...
p4 <- ggplot(data=model1predictEnvSxTn) +
              ...
              geom_point(data=stimDataNoAmbTemp,
                         aes(x=UASSharpAurISO305ExBin, y=dAnnoyMean,
...
p7 <- ggplot(data=model1predictIxS) +
              ...
              geom_point(data=stimDataNoAmb[stimDataNoAmb$SessionPart == "A", ],
                         aes(x=UASImpulsSHMAvgMaxLR, y=dAnnoyMean, colour=UASSharpAurISO305ExBin),
                         alpha=0.35, size=2) +
...
model1predictLxS <- ggeffects::predict_response(model1, terms=c("LAELAF50diffScl [all]",
                                                               "UASSharpAurISO305ExBin [1.2:3, by=0.4]",
                                                                 "UASEvents [1]"),
                                             margin='marginalmeans', type='fixed', 
                                            vcov=vcov(model1, type="bias-corrected"))
...
p2 <- ggplot(data=model1predictLxS) +
              ...
              geom_point(data=stimDataNoAmb, aes(x=LAELAF50diffScl, y=dAnnoyMean, colour=UASSharpAurISO305ExBin, shape=factor(UASEvents)),
                         alpha=0.55, size=2) +
...
model1 <- mABLAExSxDt5i2I1_QSq.GEE <- glmtoolbox::glmgee(dAnnoyance ~ I(UASEvents^-1) + I(Detect0p5IntMaxLRLogScl^2) + 
                                                            UASImpulsSHMAvgMaxLR +
                                                             UASLAEMaxLRScl*UASSharpAurISO305ExBin +
...
model1predictDxS <- ggeffects::predict_response(model1, terms=c("Detect0p5IntMaxLRLogScl [all]",
                                                               "UASSharpAurISO305ExBin [1.6:2.8, by=0.4]",
                                                                 "UASEvents [1]"),
                                             margin='marginalmeans', type='fixed', 
                                            vcov=vcov(model1, type="bias-corrected"))
...
p6 <- ggplot(data=model1predictEvt2) +
              theme(panel.grIDmajor = element_line(colour = "grey90", alpha=0.05, linetype='dashed'),
                 panel.grIDminor = element_blank(), aspect.ratio=0.8,
                    text = element_text(family = "serif", size=16),
                    axis.text=element_text(family = "serif", size=14)) +
...
p7 <- ggplot(data=model1predictEvt2Type) +
              theme(panel.grIDmajor = element_line(colour = "grey90", alpha=0.05, linetype='dashed'),
                 panel.grIDminor = element_blank(), aspect.ratio=1.15,
                    text = element_text(family = "serif", size=16),
                    axis.text=element_text(family = "serif", size=14)) +
...
geeModelPerformance(mABdHTypexOpxLAExEnvlgQxLAE.GEE, mABdHTypexOpxLAExEnvlgQxLAENatAtt.GEE)
