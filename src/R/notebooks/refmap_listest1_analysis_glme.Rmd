...
model2 <- mABTypeOpLAExEnv1_QSq.LAEEnv1_Q <- lme4::lmer(dAnnoyance ~  UASType + UASOperation +
                                                       UASLAEMaxLRScl*AmbientEnv +
                                                        PartTrialNumberScl + UASEvents + I(UASEvents^-1) +
                                                       (1 + I(UASEvents^-1) +
...
dataFrame <- subjData |> group_by(PartTrialNumberScl) |> summarise(dAnnoyance = mean(dAnnoyance))

ggplot(data=dataFrame, mapping=aes(PartTrialNumberScl, dAnnoyance)) + geom_point(color=mycolours[1], alpha=0.3) +
...
model2 <- mABLAExEnv1_QSq.LAEEnv1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                UASLAEMaxLRScl*AmbientEnv +
                                                UASEvents + I(UASEvents^-1) +
...
flexplot::visualize(model2, plot='model',
                    sample=length(levels(subjDataNoAmb$ID)), alpha=0.1,
                    formula = dAnnoyance ~ PartTrialNumberScl + ID | AmbientEnv) +
  labs(x="Trial number (standardised)", y="Change in annoyance rating\n(rel. to baseline)")

# refit to remove redundant UASEvents variable
model2 <- mABLAExEnv1_QSq.LAEEnv1_Q <- stats::update(model2, . ~ . - UASEvents)

# flexplot::compare.fits(dAnnoyance ~ UASLAEMaxLRScl | ID + AmbientEnv + PartTrialNumberScl, data=subjDataNoAmb,
#                        model1=model1, model2=model2,
#                        clusters=5, re=T, alpha=0.2)
...
model2 <- mABEPNLxEnv1_QSq.EPNLEnv1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                  UASEvents + I(UASEvents^-1) +
...
model2 <- mABNxEnv1_QSq.NEnv1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                UASEvents + I(UASEvents^-1) +
...
model2 <- mABN3xEnv1_QSq.N3Env1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                              UASEvents + I(UASEvents^-1) +
...
model2 <- mABEPNLxEnv1_QSq.EPNLxEnv1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                   UASEvents + I(UASEvents^-1) +
                                                    UASEPNLMaxLRScl*AmbientEnv +
                                                    (1 + I(UASEvents^-1) + UASEPNLMaxLRScl*AmbientEnv | ID),
                                                    data=subjDataNoAmb, control=lmcontrol, REML=FALSE)
...
model2 <- mABTnLAExEnv1_QSq.LAEEnv1_Q <- lme4::lmer(dAnnoyance ~ UASTonLdECMAPowAvgBin + PartTrialNumberScl +
                                                 UASEvents + I(UASEvents^-1) +
                                                  UASLAEMaxLRScl*AmbientEnv +
...
model2 <- mABTLAExEnv1_QSq.LAEEnv1_Q <- lme4::lmer(dAnnoyance ~ UASTonalSHMInt05ExMaxLR + PartTrialNumberScl +
                                                 UASEvents + I(UASEvents^-1) +
                                                  UASLAEMaxLRScl*AmbientEnv +
                                                  (1 + I(UASEvents^-1) + UASLAEMaxLRScl + AmbientEnv | ID),
                                                  data=subjDataNoAmb, control=lmcontrol, REML=FALSE)
...
model2 <- mABTEPNLxEnv1_QSq.EPNLEnv1_Q <- lme4::lmer(dAnnoyance ~ UASTonalSHMInt05ExMaxLR + PartTrialNumberScl +
                                                   UASEvents + I(UASEvents^-1) +
                                                    UASEPNLMaxLRScl*AmbientEnv +
                                                    (1 + I(UASEvents^-1) + UASEPNLMaxLRScl + AmbientEnv | ID),
                                                    data=subjDataNoAmb, control=lmcontrol, REML=FALSE)
...
model2 <- mABTLAExEnv1_QSq.TLAEEnv1_Q <- lme4::lmer(dAnnoyance ~ UASTonalSHMInt05ExMaxLR + PartTrialNumberScl +
                                                   UASEvents + I(UASEvents^-1) +
                                                  UASLAEMaxLRScl*AmbientEnv +
...
model2 <- mABLAExTxEnv1_QSq.LAEEnv1_Q <- lme4::lmer(dAnnoyance ~  PartTrialNumberScl +
                                                   UASEvents + I(UASEvents^-1) +
...
model2 <- mABShmxTn1_LAE2xEnv1_QSq.LAEEnv1_Q <- lme4::lmer(dAnnoyance ~ UASSharpAurSHM05ExMaxLR*UASTonLdECMAPowAvgBin +
                                                     UASLAEMaxLRScl*AmbientEnv +
                                                       I(UASLAEMaxLRScl^2) + I(UASLAEMaxLRScl^-1) +
                                                      PartTrialNumberScl + I(UASEvents^-1) +
                                                     (1 + I(UASEvents^-1) +
                                                        UASLAEMaxLRScl + AmbientEnv | ID),
                                                     data=subjDataNoAmb, control=lmcontrol, REML=FALSE)
...
model2 <- mABShmxTn1_QxLAExEnvSq.LAEEnv1_Q <- lme4::lmer(dAnnoyance ~ UASSharpAurSHM05ExMaxLR*UASTonLdECMAPowAvgBin +
                                                     UASLAEMaxLRScl*AmbientEnv +
                                                      PartTrialNumberScl + UASLAEMaxLRScl*I(UASEvents^-1) +
                                                     (1 + UASLAEMaxLRScl + I(UASEvents^-1) +
                                                        AmbientEnv | ID),
                                                     data=subjDataNoAmb, control=lmcontrol, REML=FALSE)
...
model2 <- mABShmxTn1_QxLAESq.LAE1_Q <- lme4::lmer(dAnnoyance ~ UASSharpAurSHM05ExMaxLR*UASTonLdECMAPowAvgBin +
                                                      PartTrialNumberScl + UASEvents + UASLAEMaxLRScl*I(UASEvents^-1) +
                                                     (1 + I(UASEvents^-1) +
                                                        UASLAEMaxLRScl | ID),
                                                     data=subjDataNoAmb, control=lmcontrol, REML=FALSE)
...
model2 <-  mABDt1i1_QSq.Dt1i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                             UASEvents + I(UASEvents^-1) +
...
model2 <-  mABDt5i1_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                             UASEvents + I(UASEvents^-1) +
...
model2 <-  mABDt1i21_QSq.Dt1i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                             UASEvents + I(UASEvents^-1) +
                                             Detect0p1IntMaxLRLog +
...
model2 <-  mABdSxdTnDt1i21_QSq.dSDt1i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                           UASEvents + I(UASEvents^-1) +
                                                           dSharpAurSHM05ExMaxLR*dTonLdECMAPowAvgBin +
                                                             Detect0p1IntMaxLRLog +
                                                           I(Detect0p1IntMaxLRLog^2) +
...
model2 <- mABdSxdTnDt1i21_QSqEnv.dSDt1i1_QEnv  <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl + AmbientEnv +
                                                                UASEvents + I(UASEvents^-1) +
                                                                dSharpAurSHM05ExMaxLR*dTonLdECMAPowAvgBin +
                                                                Detect0p1IntMaxLRLog + I(Detect0p1IntMaxLRLog^2) +
                                                                (1 + dSharpAurSHM05ExMaxLR + AmbientEnv +
...
model2 <- mABdSDt1i21_QSqEnv.dSDt1i1_QEnv  <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl + AmbientEnv +
                                                                UASEvents + I(UASEvents^-1) +
...
model2 <- mABdFdIdRdSdLAELAF501_QSqEnv.dSdLAELAF501_QEnv  <- lme4::lmer(dAnnoyance ~ dImpulsSHMAvgMaxLR + dFluctSHM10ExBin +
                                                                   dRoughFZ05ExMaxLR +
                                                                  PartTrialNumberScl + LAELAF50diffScl +
                                                                  UASEvents + I(UASEvents^-1) +
                                                                  dSharpAurSHM05ExMaxLR +
                                                                  AmbientEnv +
                                                                  (1 + dSharpAurSHM05ExMaxLR + AmbientEnv +
...
model2 <- mABdIdSxdTndN1_QSqEnv.dSdN1_QEnv  <- lme4::lmer(dAnnoyance ~ dImpulsSHMAvgMaxLR +
                                                                        PartTrialNumberScl + PartLoudMGLTPowAvg +
                                                                        UASEvents + I(UASEvents^-1) +
                                                                        dSharpAurSHM05ExMaxLR*dTonLdECMAPowAvgBin +
                                                                        AmbientEnv +
...
model2 <-  mABFIRSxTnDt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                UASSharpAurSHM05ExMaxLR*UASTonLdECMAPowAvgBin +
                                                 UASFluctOV10ExMaxLR + UASRoughFZ05ExMaxLR +
                                                 UASImpulsSHMAvgMaxLR +
                                             UASEvents + I(UASEvents^-1) +
...
model2 <-  mABSxTnDt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                UASSharpAurSHM05ExMaxLR*UASTonLdECMAPowAvgBin +
                                             UASEvents + I(UASEvents^-1) +
                                             Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
                                             (1 + Detect0p5IntMaxLRLog + I(UASEvents^-1) | ID),
...
model2 <-  mABISxTnDt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                UASSharpAurSHM05ExMaxLR*UASTonLdECMAPowAvgBin +
                                                  UASImpulsSHMAvgMaxLR +
                                             UASEvents + I(UASEvents^-1) +
                                             Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
...
model2 <-  mABFSxTnDt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                UASSharpAurSHM05ExMaxLR*UASTonLdECMAPowAvgBin +
                                                  UASFluctOV10ExMaxLR +
                                             UASEvents + I(UASEvents^-1) +
                                             Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
...
model2 <-  mABFISxTnDt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                UASSharpAurSHM05ExMaxLR*UASTonLdECMAPowAvgBin +
...
model2 <-  mABFISDt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
...
model2 <-  mABFITnDt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                UASTonLdECMAPowAvgBin +
                                                  UASFluctOV10ExMaxLR + UASImpulsSHMAvgMaxLR +
                                             UASEvents + I(UASEvents^-1) +
                                             Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
...
model2 <-  mABISDt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                UASSharpAurSHM05ExMaxLR +
                                                  UASImpulsSHMAvgMaxLR +
                                             UASEvents + I(UASEvents^-1) +
                                             Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
...
model2 <-  mABFSDt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                 UASSharpAurSHM05ExMaxLR +
                                                  UASFluctOV10ExMaxLR +
                                             UASEvents + I(UASEvents^-1) +
                                             Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
...
model2 <-  mABSDt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                 UASSharpAurSHM05ExMaxLR +
                                             UASEvents + I(UASEvents^-1) +
                                             Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
                                             (1 + Detect0p5IntMaxLRLog + I(UASEvents^-1) | ID),
...
model2 <-  mABSTnDt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                 UASSharpAurSHM05ExMaxLR + UASTonLdECMAPowAvgBin +
                                             UASEvents + I(UASEvents^-1) +
                                             Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
                                             (1 + Detect0p5IntMaxLRLog + I(UASEvents^-1) | ID),
...
model2 <-  mABISTnDt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                     UASImpulsSHMAvgMaxLR +
                                                 UASSharpAurSHM05ExMaxLR + UASTonLdECMAPowAvgBin +
                                             UASEvents + I(UASEvents^-1) +
                                             Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
...
model2 <-  mABFSTnDt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                     UASFluctOV10ExMaxLR +
                                                 UASSharpAurSHM05ExMaxLR + UASTonLdECMAPowAvgBin +
                                             UASEvents + I(UASEvents^-1) +
                                             Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
...
model2 <-  mABFISdLAELAF50Dt5i21_QSq.dLAELAF50Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                        UASSharpAurSHM05ExMaxLR +
                                                          UASFluctOV10ExMaxLR + UASImpulsSHMAvgMaxLR +
                                                     UASEvents + I(UASEvents^-1) +
                                                     Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
...
model2 <-  mABFISdLAELAF502Dt5i1_QSq.dLAELAF50Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                        UASSharpAurSHM05ExMaxLR +
                                                          UASFluctOV10ExMaxLR + UASImpulsSHMAvgMaxLR +
                                                     UASEvents + I(UASEvents^-1) +
                                                     Detect0p5IntMaxLRLog +
...
model2 <-  mABFISdLAELAF50Dt5i21_QSq.Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                        UASSharpAurSHM05ExMaxLR +
                                                          UASFluctOV10ExMaxLR + UASImpulsSHMAvgMaxLR +
                                                     UASEvents + I(UASEvents^-1) +
                                                     Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
...
model2 <-  mABFISdLAELAF50Dt5i21_QSq.dLAELAF501_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                        UASSharpAurSHM05ExMaxLR +
                                                          UASFluctOV10ExMaxLR + UASImpulsSHMAvgMaxLR +
                                                     UASEvents + I(UASEvents^-1) +
                                                     Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
...
model2 <-  mABFISdLAELAF502Dt5i21_QSq.dLAELAF50Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                        UASSharpAurSHM05ExMaxLR +
                                                          UASFluctOV10ExMaxLR + UASImpulsSHMAvgMaxLR +
                                                     UASEvents + I(UASEvents^-1) +
                                                     Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
...
model2 <-  mABSxTndLAELAF50Dt5i21_QSq.dLAELAF50Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                        UASSharpAurSHM05ExMaxLR*UASTonLdECMAPowAvgBin +
                                                     UASEvents + I(UASEvents^-1) +
                                                     Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
                                                       LAELAF50diffScl +
...
model2 <-  mABSdLAELAF50Dt5i21_QSq.dLAELAF50Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                        UASSharpAurSHM05ExMaxLR +
                                                     UASEvents + I(UASEvents^-1) +
                                                     Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
                                                       LAELAF50diffScl +
...
model2 <-  mABSTndLAELAF50Dt5i21_QSq.dLAELAF50Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                        UASSharpAurSHM05ExMaxLR + UASTonLdECMAPowAvgBin +
                                                     UASEvents + I(UASEvents^-1) +
                                                     Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
                                                       LAELAF50diffScl +
...
model2 <-  mABFSdLAELAF50Dt5i21_QSq.dLAELAF50Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
...
model2 <-  mABISdLAELAF50Dt5i21_QSq.dLAELAF50Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
...
model2 <-  mABFISxTndLAELAF50Dt5i21_QSq.dLAELAF50Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                                         UASFluctOV10ExMaxLR + UASImpulsSHMAvgMaxLR +
                                                        UASSharpAurSHM05ExMaxLR*UASTonLdECMAPowAvgBin +
                                                     UASEvents + I(UASEvents^-1) +
                                                     Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
...
model2 <-  mABFSxTndLAELAF50Dt5i21_QSq.dLAELAF50Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                                         UASFluctOV10ExMaxLR +
                                                        UASSharpAurSHM05ExMaxLR*UASTonLdECMAPowAvgBin +
                                                     UASEvents + I(UASEvents^-1) +
                                                     Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
...
model2 <-  mABISxTndLAELAF50Dt5i21_QSq.dLAELAF50Dt5i1_Q <- lme4::lmer(dAnnoyance ~ PartTrialNumberScl +
                                                                         UASImpulsSHMAvgMaxLR +
                                                        UASSharpAurSHM05ExMaxLR*UASTonLdECMAPowAvgBin +
                                                     UASEvents + I(UASEvents^-1) +
                                                     Detect0p5IntMaxLRLog + I(Detect0p5IntMaxLRLog^2) +
