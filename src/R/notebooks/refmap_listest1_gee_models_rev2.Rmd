...
subjDataNoAmb <- subjDataNoAmb |>
  mutate(dAnnoyanceOrd = factor(dAnnoyance, levels=seq(-10, 10, by=1), ordered=TRUE))h
...
modelMinX2 <- buildmer::buildglmmTMB(dAnnoyanceOrdBetaScl ~ 1 + TrialNumberScl +
                                     UASLAEMaxLRScl*AmbientEnv*UASOperation*UASType +
                                     UASLAEMaxLRScl*I(UASEvents^-1) +
                                  NationGeo2 + AAM_attitude2 +
                                  (1 | ID) + (1 | StimID),
...
model1 <- glmmTMB::glmmTMB(dAnnoyanceOrdBetaScl ~ 1 + TrialNumberScl +
                                     UASLAEMaxLRScl*AmbientEnv +
                                     UASLAEMaxLRScl*I(UASEvents^-1) +
                                UASLAEMaxLRScl*UASOperation +
                                  UASType +
                                  NationGeo2 + AAM_attitude2 +
                                  (1 | ID) + (1 | StimID),
                        data=subjDataNoAmb, family=gaussian,
