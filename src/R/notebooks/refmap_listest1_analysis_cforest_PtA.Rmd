...
stimDataANum <- stimDataANum |> dplyr::filter(UASLAeq != "No UAS")
...
# omit ambient-only stimuli
stimNoticeDataANum <- stimNoticeDataANum |> dplyr::filter(UASLAeq != "No UAS")
...
if (saveplots){
  ggsave(filename="PtANoticeAbsVarsConPermimp1pc.svg", width=8, height=4, path=file.path(outFigPath, "svg"))
  unlink("PtANoticeAbsVarsConPermimp1pc.svg")
  
  ggsave(filename="PtANoticeAbsVarsConPermimp1pc.pdf", width=8, height=4, path=file.path(outFigPath, "pdf"))
